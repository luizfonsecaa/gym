import { Box, Center, Heading, HStack, Icon, Image, Text, VStack, ScrollView, useToast } from "native-base";
    ...
    <VStack flex={1}>
      <VStack px={8} bg="gray.600" pt={12}>
        ...
        <HStack justifyContent="space-between" mt={4} mb={8} alignItems="center">
          <Heading color="gray.100" fontSize='lg' fontFamily='heading' flexShrink={1}>{exercise.name}</Heading>
